...
cat("The rejection rate is: ", round(reject_rate, 4)," . The expected rejection rate is: ", round(expected_rejection, 4), " \ The difference in rejection rate is: ",difference)

```

The rejection rates is very similar to the expected rejection rate. They differ by just 0.4\%
